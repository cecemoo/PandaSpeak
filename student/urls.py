...
urlpatterns = [
    ...
    path('subscription_plans/', subscription_views.subscription_plans, name='subscription_plans'),
    path('account_management_student/', subscription_views.account_management, name='account_management_student'), 
